...
let skybox = new T.CubeTextureLoader().load([
    "./textures/final_skybox/Right.png",
    "./textures/final_skybox/Left.png",
    "./textures/final_skybox/Top.png",
    "./textures/final_skybox/Front.png",
    "./textures/final_skybox/Back.png",
    "./textures/final_skybox/Bottom.png"
])
world.scene.background = skybox;
//world.add(new Building2())
// let terrain = new GroundTerrain()
// // console.log(terrain);
//  world.add(terrain)
// console.log(terrain);
