...
export class SimpleGroundPlane extends GrObject {
  ...
  constructor(size = 5, thickness = 0.2, color = "white") {
    ...
    const normal = new T.TextureLoader().load("../../for_students/textures/ground textures/forest_leaves_02_nor_dx_2k.jpg")
    const ao = new T.TextureLoader().load("../../for_students/textures/ground textures/forest_leaves_02_ao_2k.jpg")
    const rough = new T.TextureLoader().load("../../for_students/textures/ground textures/forest_leaves_02_rough_2k.jpg")
    //const disp = new T.TextureLoader().load("../../for_students/textures/ground textures/forest_leaves_02_disp_2k.jpg")
    const map =  new T.TextureLoader().load("../../for_students/textures/ground textures/forest_leaves_02_diffuse_2k.jpg")
    const material = new T.MeshStandardMaterial({ 
      color: "grey", roughness: 0.9 , normalMap:normal,roughnessMap:rough,
      aoMap:ao, map:map
    });
    const mesh = new T.Mesh(geometry, material);
    //const ambient = new T.AmbientLight("white",0.5)
    numberOfGrounds += 1;
